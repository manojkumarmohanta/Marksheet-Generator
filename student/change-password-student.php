...
$sql ="SELECT Email AND Password FROM student WHERE Email=:emailid and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update student set Password=:newpassword where Email=:emailid";
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                        <input type="text" name="emailid" class="form-control" required="required" id="success">
