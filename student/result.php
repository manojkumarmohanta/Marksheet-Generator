...
$qery = "SELECT student.student_name,student.Branch,student.id,tblresult.StudentId,tblresult.Semester  from student join tblresult on tblresult.StudentId=student.id where student.id='$rollid' and student.DOB='$dob' and student.Branch='$branch' and Semester='$semester' ";
...
// Code for result
 ...
 $query ="select * from tblresult where StudentId='$rollid' and Branch='$branch'";
