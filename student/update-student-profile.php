                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="../student/dashboard-student.php"><i class="fa fa-home"></i> Home</a></li>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form action="../service/update-student-profile-database.php" name="updateprofile" method="POST" enctype="multipart/form-data">

                                                <div class="form-group has-success">
                                                        <label for="success" class="control-label">Roll ID</label>
                                                		<div class="">
                                                            <input type="text" name="rollid" class="form-control" required="required" id="success" value="<?php //echo htmlentities($result->id);?>">
                                                ...
                                                <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            <input type="text" name="chngname" class="form-control" required="required" id="success" value="<?php echo htmlentities($result->student_name);?>">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <input type="hidden" name="image_old" value="<?php echo "uploaded_images/".$result->image;?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group has-success">
