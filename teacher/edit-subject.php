...
if($query){
    ...
    echo "<script type='text/javascript'> window.document.location = '../teacher/manage-subject-teacher.php'; </script>";
}
}
...
$sql="delete from tblsubjects where SubjectName=:subjectname";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
