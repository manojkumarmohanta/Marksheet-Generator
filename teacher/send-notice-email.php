                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Send Notice Mail to All Approved Students</h2>
                                
                                </div><br>

                                <div align='right'>
                                    <form action="../service/send-notice-email-database.php" method="post">
                                        <input type="submit" name="sendnotice" value="Send Notice Mail" style=" background-color:blue; color:aliceblue; border:2px solid black; border-radius:10px; width:30%; font-size:small;"/><br><br>
                                     </form>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Send Notice Mail</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Send Notice Mail to all Approved Students</h5>
                                                </div>
                                            </div>
                                        <?php if($msg){?>
