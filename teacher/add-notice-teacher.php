...
$sql="INSERT INTO  tblnotice (nid,noticeTitle,noticeDetails) VALUES(:nid,:ntitle,:ndetails)";
...
echo "<script>window.location.href ='../teacher/add-notice-teacher.php'</script>";
}else {
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Notice No.</label>
                                                		<div class="">
