...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  student(student_name,RollId,Email,Gender,Branch,DOB,status) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status)";
...
<html lang="en">
    <head>
        ...
        <script src="j../s/modernizr/modernizr.min.js"></script>
    </head>
