            ...
            {    
                if(!file_exists($uploaded_images_teacher))
                {
                    ...
                    if($image_size_teacher<5000000)
                    {
                        ...
                        $statement1 = mysqli_query($conn, "INSERT INTO `teacher` (id,FullName,UserName,Email,Password,DOB,Branch,role,Gender,image,MobileNumber) values('$teacherid','$fullname','$username','$emailid','$password','$dob','$branch','$role','$gender','$image','$phone')");
