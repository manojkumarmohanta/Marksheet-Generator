                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="col-md-6">
                                                <h3 class="title">Student Requests</h3>
                                            </div>
                                            </div>
<?php if($msg){?>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['approvestudent']))
                                                    {
                                                        //$rollid=$_POST['rollid'];
                                                        $status='approved';
                                                        $sqlapp=mysqli_query($conn, "UPDATE `student` SET status = '$status' WHERE Email='$result->Email'; ");
                                                            ...
                                                            if($query->rowCount() > 0)
                                                            {
                                                                ...
                                                                {  ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <form action="../admin/requests.php" method="post">
                                                                                <input type="submit" name="approveteacher" class="approve" value="Approve" /><br><br>
                                                                                <input type="submit" name="denyteacher" class="reject" value="Reject" />
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['approveteacher']))
                                                    {
                                                        //$rollid=$_POST['rollid'];
                                                        $status='approved';
                                                        $sqlapp=mysqli_query($conn, "UPDATE `teacher` SET status = '$status' WHERE Email='$result->Email'; ");
