                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                            <?php $sql = "SELECT * FROM tblsubjectcombination ORDER BY id ASC";
                                                            $query = $dbh->prepare($sql);
                                                            $query->execute();
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="../admin/edit-subject-combination.php?subjectid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record"></i> </a>
                                                                    </td>
