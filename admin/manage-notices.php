...
if($_GET['id'])
{
    ...
    echo "<script>window.location.href='../admin/manage-notices.php'</script>";
}
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>
                                                        <a href="../admin/manage-notices.php?id=<?php echo htmlentities($result->nid);?>" onclick="return confirm('Do you really want to delete the notice?');">
                                                            <input type="submit" name="delete" value="Delete" class="fa fa-trash fa-2x btn btn-danger" title="Delete this Record" style="background-color:red;color:aliceblue;"> </a> 
                                                        </td>
                                                        </tr>
                                                        <?php $cnt=$cnt+1;}} ?>
                                                    </tbody>
